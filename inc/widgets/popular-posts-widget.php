...
class schools_popular_posts_widget extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'schools_tabbed_widget', 'description' => __('Displays tabbed list of popular posts, recent posts & comments', 'schools') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'schools_tabbed_widget' );

		/* Create the widget. */
		parent::__construct( 'schools_tabbed_widget', __('Schools: Popular Posts Widget', 'schools'), $widget_ops, $control_ops );
	}
        ...
        <div class="widget tabbed">
            <div class="tabs-wrapper">
                <ul class="nav nav-tabs">
                      <li class="active"><a href="#popular-posts" data-toggle="tab"><?php _e('Popular', 'schools') ?></a></li>
                      <li><a href="#recent" data-toggle="tab"><?php _e('Recent', 'schools') ?></a></li>
            ...
            <div class="tab-content">
                ...
                <?php foreach($recent_comments as $comment) : ?>
                    ...
                    <li>
                        <div class="content">
                            <?php if ( $comment->comment_author ) { echo $comment->comment_author; } else { _e('Anonymous','schools'); } ?> <?php _e('on','schools'); ?>
	...
	function form( $instance ) {
		...
		<!-- Number of posts -->
		<p>
			<label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e('Number of posts to show','schools') ?>:</label>
