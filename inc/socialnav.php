...
function register_social_menu() {
	register_nav_menu( 'social-menu', _x( 'Social Menu', 'nav menu location', 'schools' ) );
}

if ( ! function_exists( 'schools_social_icons' ) ) :
/**
 * Display social links in footer and widgets
 *
 * @package schools
 */
function schools_social_icons(){
...
/* Schools Social Nav CSS */
function schools_social_css(){ ?>
    <style type="text/css">
        #social li {
...
add_action( 'wp_head', 'schools_social_css', 10 );